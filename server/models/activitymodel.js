...
const FitnessSchema = mongoose.Schema({
  ...
  ActivityChecked:{
    type:String,
    enum:["walking","running","swimming","cycling"],
    default:"walking"
  },
  Owner:{
...
const calculateWalkingCalories = (Duration, Intensity, Distance, Weight, Height, Gender, Age) => {
  // MET stands for Metabolic Equivalent of Task, a measure that estimates the energy expenditure of various activities.
  let MET = 3.8;
...
module.exports = { Fitness,calculateWalkingCalories,calculateRunningCalories,calculateCyclingCalories,calculateSwimmingCalories };